//------------------------------------------------------------------------------
// <copyright file="ControllerActionGeneratorVSCommandPackage.cs" company="Microsoft">
...
namespace RazorPowerTools.VSIX.ControllerActionGeneratorCommand
{
    ...
    {
        /// <summary>
        /// ControllerActionGeneratorVSCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "4cc58039-371d-4373-93a8-90f84ec7488d";

        /// <summary>
        /// Initializes a new instance of the <see cref="ControllerActionGeneratorVSCommand"/> class.
        /// </summary>
        public ControllerActionGeneratorVSCommandPackage()
        {
